package com.amvlabs.minigames.games
...
import com.amvlabs.minigames.databinding.ActivityTicTacToeBinding
...
//    val play = MediaPlayer()
    ...
    private lateinit var bind:ActivityTicTacToeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind = ActivityTicTacToeBinding.inflate(layoutInflater)
...
//        save = getSharedPreferences("save",MODE_PRIVATE)
        ...
        volume = audioManger.getStreamVolume(AudioManager.STREAM_MUSIC)
            .toFloat() / audioManger.getStreamMaxVolume(AudioManager.STREAM_MUSIC)
    ...
    private fun checkWinner(): Boolean {
        ...
        if (!gameActive) {
            ...
            if (state[0] != 2 && state[1] != 2 && state[2] != 2
                ...
                val dialog =
                    AlertDialog.Builder(this).setMessage("No one Wins\ndo you want to play again")
